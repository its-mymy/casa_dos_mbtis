...
botaoBaixarCard.addEventListener(
    ...
    async () => {
        ...
        try {
            ...
            /* =================================================
               CELULAR
               TENTATIVA 1 — COMPARTILHAR ARQUIVO
            ================================================= */
            ...
            if (novaAba) {
                ...
                mostrarToast(
                    "✨ Imagem aberta! Toque e segure para salvar."
                );
